...
const index = () => {
    ...
    return (
        <div className="flex flex-col items-center mx-20 my-20 bg-[#F2EFEF] rounded-lg font-sans ">
            ...
            <div className="flex flex-row items-center w-3/4 h-full rounded-xl  drop-shadow-xl p-2 my-3 font-sans">
                        ...
                        <div className="pt-3 ">
                            ...
                            <div className="flex space-x-2 pt-3">
                                ...
                                <div className="flex space-x-2 ml-5">
                                    <button
                                        className="bg-[#24AB82] drop-shadow-md  text-white text-xl rounded-xl px-6 py-2 mt-2 mb-2 hover:bg-[#1F795E] "
                                        onClick={saveFile}
                                    >
                                        ดาวน์โหลด
                                    </button>
                            ...
                            <div className="flex space-x-2 pt-5">
                                ...
                                <div className="flex space-x-3 ml-5">
                                    <div className="flex space-x-8">
                                        <button className=" bg-[#24AB82] drop-shadow-md font-bold text-white text-2xl rounded-xl px-10 py-2.5 hover:bg-[#1F795E] hover:ring-2 hover:ring-white ">
                                            ผ่าน
                                        </button>
